...
// Must have passed admin password verification
...
// Stats
$total  = intval($con->query("SELECT COUNT(*) as c FROM participants")->fetch_assoc()['c']);
$male   = intval($con->query("SELECT COUNT(*) as c FROM participants WHERE gender='Male'")->fetch_assoc()['c']);
$female = intval($con->query("SELECT COUNT(*) as c FROM participants WHERE gender='Female'")->fetch_assoc()['c']);
$today  = intval($con->query("SELECT COUNT(*) as c FROM participants WHERE DATE(date)=CURDATE()")->fetch_assoc()['c']);
